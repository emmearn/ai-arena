...
| Giudizio Judge instabile o allucinato | Judge post-sintesi, final answer, supervisor consultivo | Rubrica esplicita, output strutturato validato, fallback controllato, limiti applicativi prevalenti e test su verdict/risposte malformate. | Bias, variabilita' e falsa sicurezza restano rischi residui del modello. |
